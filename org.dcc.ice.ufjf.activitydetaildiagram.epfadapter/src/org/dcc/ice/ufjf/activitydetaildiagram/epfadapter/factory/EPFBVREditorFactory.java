 ...
 ******************************************************************************/
package org.dcc.ice.ufjf.activitydetaildiagram.epfadapter.factory;
...
import org.dcc.ice.ufjf.activitydetaildiagram.epfadapter.EPFBVREditorAdapter;
...
public class EPFBVREditorFactory implements IAdapterFactory {
	...
	public Object getAdapter(final Object adaptableObject, Class adapterType) {
		...
		if (adapterType == IBVREnabledEditor.class
				&& adaptableObject instanceof ActivityDetailDiagramEditor) {
			...
			ActivityDetailDiagramEditor editor = (ActivityDetailDiagramEditor) adaptableObject;
