...
//------------------------------------------------------------------------------
package org.dcc.ice.ufjf.epfadapter2.editors;
...
public class MethodElementEditor extends AbstractBaseFormEditor implements
	...
	protected void createEditorErrorTickUpdater() {
		...
		this.fMethodElementEditorErrorTickUpdater = 
				new MethodElementEditorErrorTickUpdater(null);
	}
	...
	/**
	 * @see org.dcc.ice.ufjf.epfadapter2.editors.AbstractBaseFormEditor#dispose()
	 */
	public void dispose() {
		try {
	...
	/**
	 * @see org.dcc.ice.ufjf.epfadapter2.editors.AbstractBaseFormEditor#isDirty()
	 */
...
//				Object oldContent = modalObject.eGet(modalObjectFeature);
	...
	/**
	 * @see org.dcc.ice.ufjf.epfadapter2.editors.AbstractBaseFormEditor#doSave(org.eclipse.core.runtime.IProgressMonitor)
	 */
