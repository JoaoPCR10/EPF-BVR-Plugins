 ...
 ******************************************************************************/
package org.dcc.ice.ufjf.formdiagram.epfadapter2.editors;
 ...
 */
public abstract class FormBVREditor extends FormEditor implements IBVREnabledEditor {
	...
	public void setColor(EObject obj, Color fg, IEditorPart editor) {
		...
		for (Object object : editParts) {
			if(object instanceof FormEditor){
				FormEditor ep = (FormEditor) object;
