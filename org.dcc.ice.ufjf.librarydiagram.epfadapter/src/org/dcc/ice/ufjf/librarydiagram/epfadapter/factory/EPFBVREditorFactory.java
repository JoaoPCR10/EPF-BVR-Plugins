 ...
 ******************************************************************************/
package org.dcc.ice.ufjf.librarydiagram.epfadapter.factory;
...
import org.dcc.ice.ufjf.librarydiagram.epfadapter.EPFBVREditorAdapter;
...
public class EPFBVREditorFactory implements IAdapterFactory {
	...
	public Object getAdapter(final Object adaptableObject, Class adapterType) {
		...
		if (adapterType == IBVREnabledEditor.class
				&& adaptableObject instanceof MethodLibraryEditor) {
			...
			MethodLibraryEditor editor = (MethodLibraryEditor) adaptableObject;
