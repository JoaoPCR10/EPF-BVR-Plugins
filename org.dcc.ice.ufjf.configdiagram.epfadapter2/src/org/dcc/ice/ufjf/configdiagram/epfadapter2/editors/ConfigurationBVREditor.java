 ...
 ******************************************************************************/
package org.dcc.ice.ufjf.configdiagram.epfadapter2.editors;
 ...
 */
public class ConfigurationBVREditor extends ConfigurationEditor implements IBVREnabledEditor {
	...
	public void setColor(EObject obj, Color fg, IEditorPart editor) {
		...
		for (Object object : editParts) {
			if(object instanceof ConfigurationEditor){
				ConfigurationEditor ep = (ConfigurationEditor) object;
