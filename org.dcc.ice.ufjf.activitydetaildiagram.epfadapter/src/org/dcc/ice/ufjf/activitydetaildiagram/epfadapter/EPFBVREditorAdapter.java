 ...
 ******************************************************************************/
package org.dcc.ice.ufjf.activitydetaildiagram.epfadapter;
...
public class EPFBVREditorAdapter extends AbstractBVREnabledEditor {
	...
	private ActivityDetailDiagramEditor editor;
	...
	public EPFBVREditorAdapter(ActivityDetailDiagramEditor _editor) {
		editor = _editor;
	}
	...
	public void setColor(EObject obj, Color fg, IEditorPart editor) {
		...
		for (Object object : editParts) {
			...
			if(object instanceof ActivityDetailDiagramEditPart)	{
			//IPapyrusEditPart ep = (IPapyrusEditPart) object;
				ActivityDetailDiagramEditPart ep = (ActivityDetailDiagramEditPart) object;
				//eop.getFigure()
