 ...
 ******************************************************************************/
package org.dcc.ice.ufjf.elementdiagram.epfadapter.factory;
...
import org.dcc.ice.ufjf.elementdiagram.epfadapter.EPFBVREditorAdapter;
...
public class EPFBVREditorFactory implements IAdapterFactory {
	...
	public Object getAdapter(final Object adaptableObject, Class adapterType) {
		...
		if (adapterType == IBVREnabledEditor.class
				&& adaptableObject instanceof MethodElementEditor) {
			...
			MethodElementEditor editor = (MethodElementEditor) adaptableObject;
