 ...
 ******************************************************************************/
package org.dcc.ice.ufjf.abstractbaseformdiagram.epfadapter.factory;
...
import org.dcc.ice.ufjf.abstractbaseformdiagram.epfadapter.EPFBVREditorAdapter;
...
public class EPFBVREditorFactory implements IAdapterFactory {
	...
	public Object getAdapter(final Object adaptableObject, Class adapterType) {
		...
		if (adapterType == IBVREnabledEditor.class
				&& adaptableObject instanceof AbstractBaseFormEditor) {
			...
			AbstractBaseFormEditor editor = (AbstractBaseFormEditor) adaptableObject;
